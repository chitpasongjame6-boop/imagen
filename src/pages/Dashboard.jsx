...
import { TrendingUp, AlertCircle, Wallet, Phone, Users, CheckCircle } from 'lucide-react'
import {
      ...
      <div className="card">
        ...
        <ResponsiveContainer width="100%" height={180}>
          <AreaChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
            ...
            <Area type="monotone" dataKey="ยอดขาย" stroke="#3b82f6" fill="url(#colorSales)" strokeWidth={2} />
            <Area type="monotone" dataKey="เก็บได้" stroke="#10b981" fill="url(#colorPaid)" strokeWidth={2} />
          </AreaChart>
        </ResponsiveContainer>
